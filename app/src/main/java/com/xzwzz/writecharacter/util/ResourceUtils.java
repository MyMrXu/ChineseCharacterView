...
public class ResourceUtils {
    ...
    public static int getIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "id", AppContext.context.getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "string", AppContext.context.getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "color", AppContext.context.getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "dimen", AppContext.context.getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "drawable", AppContext.context.getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "mipmap", AppContext.context.getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "layout", AppContext.context.getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "style", AppContext.context.getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "anim", AppContext.context.getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return AppContext.context.getResources().getIdentifier(name, "menu", AppContext.context.getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = AppContext.context.getAssets().list(assetsFilePath);
            if (assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        AppContext.context.getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = AppContext.context.getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(AppContext.context.getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                AppContext.context.getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(AppContext.context.getResources().openRawResource(resId), charsetName);
    }
